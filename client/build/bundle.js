...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListBox = __webpack_require__(159);
	
	window.onload = function () {
	  ReactDOM.render(React.createElement(ListBox, null), document.getElementById('app'));
	};
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "p",
	        { className: "title" },
	        " Australian Openings this Week "
	      ),
	      React.createElement(ListItem, { className: "list-item", data: this.state.data, href: this.state.url }),
	      React.createElement("br", null),
	      React.createElement(
	        "a",
	        { href: "http://www.imdb.com/calendar/?region=gb&pf_rd_m=A2FGELUUNOQJNL&pf_rd_p=1970868962&pf_rd_r=011BDW7VB6J9P5KHRY2D&pf_rd_s=right-2&pf_rd_t=15061&pf_rd_i=homepage&ref_=hm_otw_sm" },
	      ...
	      React.createElement(
	        "a",
	        { href: "http://www.imdb.com/showtimes/AU/2289" },
	        React.createElement(
	          "button",
	          null,
	          "Get Show Times"
	...
	var ListItem = React.createClass({
	  ...
	  render: function render() {
	    var films = this.props.data.map(function (film) {
	      return React.createElement(Film, { name: film.name, url: film.url, key: film.id });
	    });
